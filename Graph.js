            ...
            this.socket.on("live_consumption", (data) => {
                ...
                if (
                    ...
                    if (this.chart && this.lastSessionId == data.sessionId) {
                        ...
                        this.chart.update(); // FORCE LA MISE À JOUR VISUELLE
                    } else {
                        console.log(
                    ...
                    console.log(
                        `⚠️ Ignoré : User Actuel (${currentId}) != User Reçu (${data.userId})`
                    );
                }
            });
        }
    ...
    updateGraph(labels, values) {
        ...
        this.chart = new Chart(this.ctx, {
            ...
            options: {
                ...
                // On garde les proportions pour éviter qu'il ne s'étire trop
                maintainAspectRatio: true,

                // Format rectangulaire standard (2x plus large que haut)
                aspectRatio: 2,
